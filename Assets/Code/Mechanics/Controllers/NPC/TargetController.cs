...
public class TargetController : MonoBehaviour
{
    ...
    [SerializeField]
    private StarshipController currentTarget;
    public StarshipController CurrentTarget
    {
    ...
    /// </summary>
    public event Action<StarshipController> targetEntersRange;

    /// <summary>
    /// Fires when a targetable exits the target collider
    /// </summary>
    public event Action<StarshipController> targetExitsRange;

    /// <summary>
    /// Fires when an appropriate target is found
    /// </summary>
    public event Action<StarshipController> acquiredTarget;
    ...
    /// </summary>
    public List<StarshipController> targetsInRange = new List<StarshipController>();

    /// <summary>
    /// Returns the current target
    /// </summary>
    public StarshipController GetTarget()
    {
    ...
    /// </summary>
    public List<StarshipController> GetAllTargets()
    {
    ...
    public bool IsTargetableValid(StarshipController targetable)
    {
        if (targetable == null)      
            return false;     
    ...
    {
        var targetable = other.GetComponent<StarshipController>();
    ...
    public StarshipController GetNearestTargetable()
    {
        ...
        StarshipController nearest = null;
        float distance = float.MaxValue;
        for (int i = length - 1; i >= 0; i--)
        {
            StarshipController targetable = targetsInRange[i];
    ...
    private void Start()
    {
        ...
        scanRadius = triggerCollider.radius;
    }
    ...
    /// </summary>
    void OnTargetRemoved(StarshipController target)
    {
